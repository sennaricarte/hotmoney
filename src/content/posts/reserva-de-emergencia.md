...
description: "Reserva de emergência: quanto guardar por perfil, onde investir com liquidez diária (Tesouro Selic, CDB) e erros comuns. Guia prático com fontes oficiais."
pubDate: 2026-06-12
...
Este guia faz parte do nosso [hub de finanças pessoais](/financas-pessoais). Aqui você encontra valores, passo a passo de cálculo e o que evitar — sempre com base em fontes oficiais ([Tesouro Direto](https://www.tesourodireto.com.br/sobre-o-tesouro/regras-e-regulamento), [Banco Central](https://www.bcb.gov.br/content/cidadaniafinanceira/documentos_cidadania/Cuidando_do_seu_dinheiro_Gestao_de_Financas_Pessoais/caderno_cidadania_financeira.pdf), [FGC](https://fgc.org.br/sobre-garantia-fgc)).
...
O [Caderno de Educação Financeira do Banco Central](https://www.bcb.gov.br/content/cidadaniafinanceira/documentos_cidadania/Cuidando_do_seu_dinheiro_Gestao_de_Financas_Pessoais/caderno_cidadania_financeira.pdf) recomenda formar poupança para "eventuais emergências" depois de conseguir um orçamento superavitário (gastar menos do que recebe). A ideia é simples: quando o imprevisto chega, você **não precisa entrar no rotativo do cartão**, pedir empréstimo caro ou vender investimento de longo prazo no pior momento.
...
Se você ainda está construindo essa base, combinar reserva com [estratégias de renda extra](/renda-extra) pode acelerar o processo — mas renda complementar **não substitui** o hábito de separar um valor fixo todo mês.
...
1. **Liste despesas essenciais mensais** — use extratos dos últimos três meses e ignore gastos extras.
2. **Some o total** — esse é o seu "custo de sobrevivência" mensal.
3. **Multiplique pelo número de meses** da faixa do seu perfil (ex.: R$ 4.000 × 6 = R$ 24.000).
4. **Ajuste conforme contexto** — dívidas caras, dependentes ou profissão sazonal pedem meta mais alta.
...
Enquanto monta a reserva, ferramentas como [cashback](/o-que-e-cashback) podem devolver parte do que você já gasta — mas o aporte principal deve vir do orçamento, não de "sobras" aleatórias.
...
O **Tesouro Selic** (LFT) acompanha a taxa Selic e é o título público mais indicado para reserva. O [Tesouro Direto](https://www.tesourodireto.com.br/sobre-o-tesouro/regras-e-regulamento) garante **liquidez diária** em dias úteis, das 9h30 às 18h. Regras de crédito na conta:
...
- **Consórcio, previdência fechada ou investimentos sem liquidez** — recursos presos quando você mais precisa. Planejamentos como [consórcio de carro](/consorcio-de-carro) são ferramentas de **objetivo de médio prazo**, não substituto de reserva.
- **Debaixo do colchão (conta corrente parada)** — perde para a inflação e não rende nada.

## Erros comuns ao montar a reserva

1. **Confundir reserva com objetivo** — reserva não financia viagem, carro ou reforma planejada.
2. **Guardar pouco por perfil errado** — autônomo com 2 meses de reserva está exposto.
3. **Buscar rentabilidade máxima** — a reserva prioriza **segurança e acesso**, não performance.
4. **Concentrar tudo acima do limite do FGC** em um único banco.
5. **Parar de repor depois de usar** — usou R$ 5 mil no conserto? Volte a aportar até recompor.
6. **Demorar a investir o que está "sobrando"** — dinheiro parado na conta corrente perde poder de compra.
...
As opções mais usadas são **Tesouro Selic** (liquidez diária em dias úteis, conforme [horários do Tesouro Direto](https://www.tesourodireto.com.br/sobre-o-tesouro/regras-e-regulamento)), **CDB de liquidez diária** e **conta ou caixinha remunerada** com resgate imediato. Para valores acima de R$ 250 mil, distribua entre instituições por causa do limite do [FGC](https://fgc.org.br/sobre-garantia-fgc).
